    ...
    (function (directives) {
        ...
        var ccSpinner = (function () {
            ...
            ccSpinner.prototype.link = function (scope, element, attrs) {
                ...
                scope.$on('cc-spinner:spin', function (event, key) {
                    if (key[0] === scope.key) {
                ...
                scope.$on('cc-spinner:stop', function (event, key) {
                    app.global.spinner.stop();
                });
        ...
        directives.ccSpinner = ccSpinner;
                ...
                return $(element).iCheck({
                    ...
                    if ($(element).attr('type') === 'checkbox' && $attrs['ngModel']) {
                        $scope.$apply(function () {
                            return ngModel.$setViewValue(jQuery(event.target).is(":checked"));
                        });
                    }
...
//# sourceMappingURL=../src/Directives.js.map
