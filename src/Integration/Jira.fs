...
module Jira  =
    ...
    let outputRoadmap() = 
        try
            let url = "https://atlassian.au.challenger.net/jira/rest/api/2/search?jql=project=DPMIT-PROJECTS&fields=id,key,status,customfield_10360,duedate,summary,environment,status,issuelinks&maxResults=100"
