...
namespace Lacjam.Framework.Extensions
{
    public static class EnumExtensions
    {
        ...
        {
            XmlEnumAttribute[] attributes = (XmlEnumAttribute[])enumerationValue.GetType().GetField(enumerationValue.ToString()).GetCustomAttributes(typeof(XmlEnumAttribute), false);
        ...
        public static T GetEnumAttribute<T>(this Enum enumerationValue) where T : Attribute
        {
            return
                ((T[])
                 enumerationValue.GetType().GetField(enumerationValue.ToString()).GetCustomAttributes(typeof (T), false))
                    .FirstOrDefault();
        }
        ...
        public static string GetDescription(this Enum enumerationValue)
        {
            if (enumerationValue == null)
                return null;
            var attributes = (DescriptionAttribute[])enumerationValue.GetType().GetField(enumerationValue.ToString()).GetCustomAttributes(typeof(DescriptionAttribute), false);
