...
namespace Lacjam.Framework.Converters
{
    public class DateJsonConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            {
                serializer.Serialize(writer, dateTime.Value.Date.ToString("yyyy-MM-dd"));
            }
        }
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            else if (System.DateTime.TryParseExact(dateTimeString, DateFormats, CultureInfo.InvariantCulture, DateTimeStyles.None, out result))
            {
                return result;
            }
            else
