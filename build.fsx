...
let summary = "The project on a journey"
...
let authors = [ "Chris McKelt" ]
// Tags for your project (for NuGet package)
let tags = "F# fsharp tags which describe your project"

// File system information 
// (<solutionFile>.sln is built during the building process)
let solutionFile  = "Lacjam"
// Pattern specifying assemblies to be tested using NUnit
let testAssemblies = ["tests/*/bin/*/Lacjam*Tests*.dll"]

// Git configuration (used for publishing documentation in gh-pages branch)
// The profile where the project is posted 
let gitHome = "https://github.com/chrismckelt"
